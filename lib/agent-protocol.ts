...
export const agentActionSchema=z.discriminatedUnion('type',[
 ...
 z.object({type:z.literal('browser'),summary,operation:z.enum(['read','navigate']),url:z.string().max(2048).optional()}).strict(),
